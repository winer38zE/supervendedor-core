#!/usr/bin/env python3
"""
scripts/setup_planes_config_collection.py
────────────────────────────────────────────────────────────────────────────────
Crea la colección PocketBase `planes_config` para el configurador de planes.

Uso (PowerShell):
    python scripts/setup_planes_config_collection.py
"""
...
COLLECTION_NAME = os.getenv("PLANES_CONFIG_COLLECTION", "planes_config").strip() or "planes_config"
...
COLLECTION_PAYLOAD = {
    ...
    "fields": [
        ...
        {"name": "usar_bundle", "type": "bool", "required": False},
        {"name": "planes_seleccionados", "type": "json", "required": False},
        {"name": "total_mes", "type": "number", "required": True},
        {"name": "valor_regular", "type": "number", "required": False},
        {"name": "descuento", "type": "number", "required": False},
        {"name": "detalle", "type": "json", "required": False},
    ],
    "indexes": [
